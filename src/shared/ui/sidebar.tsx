...
const menuItems = [
  { href: "/", label: "Descobrir", icon: DiscoverIcon },
  { href: "/category", label: "Categorias", icon: CategoryIcon },
  { href: "/library", label: "Minha Biblioteca", icon: LibraryIcon },
  { href: "/downloads", label: "Downloads", icon: DownloadIcon },
  { href: "/audio-books", label: "Audio Books", icon: AudioBookIcon },
